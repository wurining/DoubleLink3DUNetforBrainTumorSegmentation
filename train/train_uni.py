...
if is_continue_train:
    ...
    last_checkpoint_path = "/home/csunix/ml20r2w/Documents/not-backed-up/save_model/model_MPN_20211251651_54_250sample_1batch_200epoch/checkpoints/cp-0060.ckpt.index"
    manager = tf.train.Checkpoint(GoodModel=model)
    manager.restore(last_checkpoint_path)
